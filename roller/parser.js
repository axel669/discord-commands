...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { Dice: peg$parseDice };
  var peg$startRuleFunction = peg$parseDice;
  ...
  var peg$e3 = peg$literalExpectation("a", false);
  ...
  var peg$f0 = function(sign, count, size, meta) {
    	return { sign, count, size, meta }
    };
  var peg$f1 = function(type, mod, take) {
    	return {
        	type,
            mod: mod?.[1] ?? null,
            take: take?.[1] ?? null,
  ...
  var peg$f2 = function(count) { return parseInt(count) };
  var peg$f3 = function(sign) { return parseInt(`${sign?.[1] ?? "+"}1`) };
  var peg$f4 = function(num) { return parseInt(num) };
  var peg$currPos = 0;
  var peg$savedPos = 0;
